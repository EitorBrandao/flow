...
Sem categoria não dá para lançar: a tela Lançar fica vazia. Comece pelas sugeridas (salário, pix, mercado...), que aparecem quando a box não tem nenhuma — dá para ajustar depois. Ou crie do zero: uma de ganho e três ou quatro de gasto que você reconheça no extrato. Fica em Ajustes, Categorias, com a box certa selecionada no topo.
...
- A **ordem** (arraste pela alça ⋮⋮, à esquerda do nome) é a ordem em que elas aparecem na tela Lançar. Ponha as do dia a dia no topo: é o que faz o lançamento caber em três toques.
...
- Depois disso, o gráfico da aba Fluxo deixa de ser uma linha reta: ele mostra o mês inteiro antes de ele acontecer.
...
- **Parcelas:** 1 é à vista. Em mais de uma, o app divide ao centavo e joga o resto na primeira parcela. Cada parcela cai na fatura do mês correspondente, sem você precisar lançar de novo.
...
O app não fala com o seu banco: quem garante que os dois batem é você. A [[conferência]] existe para isso doer pouco.
...
- **Na aba Cartão:** digite o valor da fatura que o banco mostra. Se não quiser caçar item por item, marque "usar este valor no Flow" e o total do banco passa a valer na projeção.
