...
- **100% local:** os dados ficam só neste aparelho, guardados pelo navegador. Sem servidor, sem conta, sem sincronização automática entre dispositivos — veja [O primeiro backup](#primeiros-passos/o-primeiro-backup).
