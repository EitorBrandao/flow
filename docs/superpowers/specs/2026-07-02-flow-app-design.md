...
- `nome` (ex.: "eitor", "ju")
- `saldoInicial` (centavos) e `dataSaldoInicial` (ex.: 1.000,00 em 2026-01-01)
...
2. **Leitura e prévia:** o parser lê `box (pessoa-a)`, `box (pessoa-b)`, `box (casa)` e
   `Simulacoes` e monta: 2 boxes + box casa, categorias (com tipo), lançamentos
