...
|---|---|---|---|---|
| backup dá a volta | garantido | antes do primeiro fechamento | passa | — |
...
| backup dá a volta | garantido | entre fechamento e vencimento | passa | — |
...
| categoria de fatura só é usada pelo cartão | garantido | entre fechamento e vencimento | passa | — |
...
| datas são AAAA-MM-DD | expectativa | entre fechamento e vencimento | passa | — |
...
| dinheiro é inteiro | expectativa | entre fechamento e vencimento | passa | — |
...
| fatura bate com os itens | garantido | entre fechamento e vencimento | passa | — |
...
| nenhuma tela lança | garantido | entre fechamento e vencimento | passa | — |
...
| referências resolvem | garantido | entre fechamento e vencimento | passa | — |
...
| uma conferência por cartão e mês | garantido | entre fechamento e vencimento | passa | — |
...
| viagens não se sobrepõem | expectativa | entre fechamento e vencimento | passa | — |
